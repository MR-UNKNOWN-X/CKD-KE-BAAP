...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@DeviLisReaper"))
    ...
    if smexxx:
        ...
        try:
            ...
            await wdk(functions.channels.JoinChannelRequest(channel="@DeviLisReaper"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk(functions.channels.JoinChannelRequest(channel="@DeviLisReaper"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk(functions.channels.JoinChannelRequest(channel="@DeviLisReaper"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk(functions.channels.JoinChannelRequest(channel="@DeviLisReaper"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk(functions.channels.JoinChannelRequest(channel="@DeviLisReaper"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk(functions.channels.JoinChannelRequest(channel="@DeviLisReaper"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk(functions.channels.JoinChannelRequest(channel="@DeviLisReaper"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk(functions.channels.JoinChannelRequest(channel="@DeviLisReaper"))
