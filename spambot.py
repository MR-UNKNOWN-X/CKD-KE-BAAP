...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(
                functions.channels.JoinChannelRequest(channel="@DeviLisReaper")
            )
            await idk(
                functions.channels.JoinChannelRequest(channel="@LithiumSpams")
            )
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(
                functions.channels.JoinChannelRequest(channel="@DeviLisReaperT")
            )
            await edk(
                functions.channels.JoinChannelRequest(channel="@LithiumSpams")
            )
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 6:
            ...
            try:
                ...
                await event.edit("👅🤧𝐒𝐄𝐂𝐂𝐄𝐒𝐒𝐅𝐔𝐋𝐋𝐘 𝐉𝐎𝐈𝐍𝐄𝐃 𝐎𝐌𝐅𝐎𝐎𝐎👅🤧")
            except Exception as e:
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 11:
            ...
            text = "Activated Reply Raid   𝐋𝐈𝐓𝐇𝐈𝐔𝐌 𝐗 𝐒𝐏𝐀𝐌   𝐋𝐈𝐓𝐇𝐈𝐔𝐌 𝐗 𝐒𝐏𝐀𝐌"
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 12:
            ...
            try:
                ...
                pass
            text = "De-Activated Reply Raid   𝐋𝐈𝐓𝐇𝐈𝐔𝐌 𝐗 𝐒𝐏𝐀𝐌"
            await e.reply(text, parse_mode=None, link_preview=None)
        elif e.reply_to_msg_id:
            a = await e.get_reply_message()
            b = await e.client.get_entity(a.sender_id)
...
text = """
CONGRATS🥳🥳🥳 YOUR FASTEST, SMOOTHEST AND POWERFUL LITHIUMSPAM DEPLOYED SUCCESSFULLY """

print(text)
print("")
print("🙏🔥🔥YOUR! LITHIUM SPAM BOT STARTED SUCCESFULLY.🔥🔥🙏")
